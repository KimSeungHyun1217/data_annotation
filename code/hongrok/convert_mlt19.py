...
SRC_DATASET_DIR = '../input/data/ICDAR19_MLT'  # FIXME
DST_DATASET_DIR = '../input/data/ICDAR19_Korean'  # FIXME
...
def main():
    ...
    mlt_train = MLT17Dataset(osp.join(SRC_DATASET_DIR, 'raw/training_images'),
    ...
    with open('/opt/ml/input/data/ICDAR17_Korean/ufo/train.json', mode='r') as f:
        anno = json.load(f)
